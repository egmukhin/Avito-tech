...
Приветствую! Меня зовут Егор :smile:  
...
Задание выполнено в связке Python + Pytest + Requests.  

В [тест-кейсах](./TESTCASES.md) проверяется работа API микросервиса объявлений:
- создание объявления;
- получение объявления по идентификатору;
- получение всех объявлений по sellerID;
- получение статистики по itemId;
- негативные проверки (обязательные поля/типы данных).  
...
1. Склонируйте к себе репозиторий, в котором хранится проект тестового задания, через выполнение команды в терминале
    ```
    git clone https://github.com/egmukhin/Avito-tech.git
